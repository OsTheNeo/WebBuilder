...
const LargeContact = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-64 bg-gradient-to-br from-orange-500 to-orange-700 flex items-center justify-center px-8 py-8">
...
LargeContact.blockMeta = {
  ...
  getTree: (data = {}) => {
    ...
    return {
      ...
      className: 'w-full h-64 bg-gradient-to-br from-orange-500 to-orange-700 flex items-center justify-center px-8 py-8',
      children: [
        {
              ...
              children: [
                {
                  ...
                  children: methods.map((method, index) => ({
                    ...
                    tag: 'div',
                    label: `${method.type}`,
                    className: 'bg-white/15 backdrop-blur-lg rounded-xl p-4 border border-white/20 hover:bg-white/25 transition-all flex items-start gap-4',
                    children: [
                      {
                ...
                },
                {
                  ...
                  tag: 'div',
                  label: 'Contact Form',
                  className: 'bg-white/20 backdrop-blur-lg rounded-2xl p-6 border border-white/25',
                  children: [
                    {
                    ...
                    },
                    {
                      ...
                      tag: 'div',
                      label: 'Social Links',
                      className: 'flex gap-4 justify-center mt-6 pt-4 border-t border-white/20',

...
const DetailedContact = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-80 bg-gradient-to-br from-orange-600 via-orange-700 to-red-800 flex items-center justify-center px-8 py-10">
...
DetailedContact.blockMeta = {
  ...
  getTree: (data = {}) => {
    ...
    return {
      ...
      className: 'w-full h-80 bg-gradient-to-br from-orange-600 via-orange-700 to-red-800 flex items-center justify-center px-8 py-10',
      children: [
        {
          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  className: 'text-lg text-orange-200 max-w-3xl mx-auto',
                  editable: true
                }
              ]
            },
            {
              ...
              children: departments.map((dept, index) => ({
                ...
                tag: 'div',
                label: dept.name,
                className: 'bg-white/15 backdrop-blur-lg rounded-2xl p-5 border-2 border-white/25 hover:bg-white/20 transition-all',
                children: [
                  {
                  ...
                  children: [
                    {
                      ...
                      tag: 'h3',
                      label: 'Offices Title',
                      className: 'font-bold text-white text-xl mb-4 flex items-center gap-2',
                      children: [
                        {

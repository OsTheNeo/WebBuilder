...
const StandardPricing = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-48 bg-gradient-to-r from-indigo-500 to-indigo-700 flex items-center justify-center px-8 py-6">
...
StandardPricing.blockMeta = {
  ...
  getTree: (data = {}) => {
    ...
    return {
      ...
      className: 'w-full h-48 bg-gradient-to-r from-indigo-500 to-indigo-700 flex items-center justify-center px-8 py-6',
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              children: plans.map((plan, index) => ({
                ...
                className: `${plan.featured ? 'bg-white text-indigo-600 scale-105' : 'bg-indigo-600/50 text-white'} backdrop-blur-sm rounded-xl p-5 text-center border-2 ${plan.featured ? 'border-white' : 'border-indigo-400/50'}`,
                children: [
                  {
                  ...
                  },
                  {
                    ...
                    className: `${plan.featured ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600'} px-4 py-2 rounded-lg font-semibold hover:opacity-90 transition-all w-full text-sm`,
                    editable: true
                  }
                ]
              }))

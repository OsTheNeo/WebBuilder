...
const CompactPricing = ({ data = {} }) => {
 ...
 <div key={index} className={`${plan.featured ? 'bg-white text-indigo-600' : 'bg-indigo-600 text-gray-900'} rounded-lg p-3 text-center transition-all hover:scale-105`}>
...
CompactPricing.blockMeta = {
 ...
 className: `${plan.featured ? 'bg-white text-indigo-600' : 'bg-indigo-600 text-gray-900'} rounded-lg p-3 text-center transition-all hover:scale-105`,
 children: [
 {

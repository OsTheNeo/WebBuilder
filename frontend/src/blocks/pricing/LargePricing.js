...
const LargePricing = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-64 bg-gradient-to-br from-indigo-500 to-indigo-700 flex items-center justify-center px-8 py-8">
      <div className="max-w-7xl w-full">
        ...
        <div className="grid grid-cols-3 gap-6">
          {plans.map((plan, index) => (
            <div key={index} className={`relative ${plan.highlighted ? 'bg-white text-indigo-600 scale-105 shadow-2xl' : 'bg-white/10 text-white backdrop-blur-md'} rounded-2xl p-6 border-2 ${plan.highlighted ? 'border-white' : 'border-white/20'} hover:scale-105 transition-all`}>
              {plan.highlighted && (
...
LargePricing.blockMeta = {
  ...
  getTree: (data = {}) => {
    ...
    return {
      ...
      className: 'w-full h-64 bg-gradient-to-br from-indigo-500 to-indigo-700 flex items-center justify-center px-8 py-8',
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              children: plans.map((plan, index) => ({
                ...
                className: `relative ${plan.highlighted ? 'bg-white text-indigo-600 scale-105 shadow-2xl' : 'bg-white/10 text-white backdrop-blur-md'} rounded-2xl p-6 border-2 ${plan.highlighted ? 'border-white' : 'border-white/20'} hover:scale-105 transition-all`,
                children: [
                  ...(plan.highlighted ? [{
                  ...
                  }] : []),
                  {
                    ...
                    children: [
                      ...
                      },
                      {
                        ...
                        className: `text-sm mb-4 ${plan.highlighted ? 'text-indigo-500' : 'text-indigo-100'}`,
                        editable: true
                      },
                      {
                  ...
                  },
                  {
                    ...
                    className: `${plan.highlighted ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600'} px-6 py-3 rounded-xl font-bold hover:opacity-90 transition-all w-full shadow-lg`,
                    editable: true
                  }
                ]
              }))

...
const DetailedPricing = ({ data = {} }) => {
 ...
 <div key={index} className={`relative ${plan.popular ? 'bg-white text-indigo-600 scale-105 shadow-2xl' : 'bg-white/10 text-gray-900 backdrop-blur-lg'} rounded-2xl p-6 border-2 ${plan.popular ? 'border-indigo-100' : 'border-gray-300/20'} transition-all hover:scale-105`}>
 {plan.popular && (
 ...
 <p className={`text-sm mb-4 ${plan.popular ? 'text-indigo-500' : 'text-gray-600'}`}>{plan.description}</p>
 <div className="mb-2">
 ...
 <button className={`${plan.popular ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600'} px-6 py-3 rounded-xl font-bold hover:opacity-90 transition-all w-full shadow-lg`}>
 {plan.buttonText}
 </button>
 </div>
 ))}
...
DetailedPricing.blockMeta = {
 ...
 className: `relative ${plan.popular ? 'bg-white text-indigo-600 scale-105 shadow-2xl' : 'bg-white/10 text-gray-900 backdrop-blur-lg'} rounded-2xl p-6 border-2 ${plan.popular ? 'border-indigo-100' : 'border-gray-300/20'} transition-all hover:scale-105`,
 children: [
 ...(plan.popular ? [{
 ...
 className: `text-sm mb-4 ${plan.popular ? 'text-indigo-500' : 'text-gray-600'}`,
 editable: true
 },
 {
 ...
 className: `${plan.popular ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600'} px-6 py-3 rounded-xl font-bold hover:opacity-90 transition-all w-full shadow-lg`,
 editable: true
 }
 ]
 }))

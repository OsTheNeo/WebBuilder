...
const FullPricing = ({ data = {} }) => {
 ...
 <p className="text-2xl text-gray-600 font-semibold mb-2">{subtitle}</p>
 <p className="text-lg text-indigo-200 mb-4">{description}</p>
 <div className="flex gap-4 justify-center">
 {features.items.map((item, index) => (
 <span key={index} className="bg-indigo-100/20 backdrop-blur-sm text-gray-900 text-xs font-semibold px-3 py-1 rounded-full">
 ✓ {item}
 </span>
 ))}
 </div>
 ...
 <div key={index} className={`relative ${plan.popular ? 'bg-white text-indigo-600 scale-105 shadow-2xl' : 'bg-white/10 text-gray-900 backdrop-blur-lg'} rounded-2xl p-5 border-2 ${plan.popular ? 'border-indigo-100' : 'border-gray-300/30'} transition-all hover:scale-105`}>
 {plan.popular && (
 ...
 <p className={`text-xs mb-3 ${plan.popular ? 'text-indigo-500' : 'text-gray-600'} line-clamp-2`}>
 {plan.description}
 </p>
 <div className="mb-2">
 ...
 <button className={`${plan.buttonStyle === 'solid' ? (plan.popular ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600') : (plan.popular ? 'border-2 border-indigo-600 text-indigo-600' : 'border-2 border-gray-300 text-gray-900')} px-4 py-2 rounded-lg font-bold hover:opacity-90 transition-all w-full shadow-lg text-sm`}>
 {plan.buttonText}
 </button>
 </div>
 ))}
...
FullPricing.blockMeta = {
 ...
 label: 'Subtitle',
 content: subtitle,
 className: 'text-2xl text-gray-600 font-semibold mb-2',
 editable: true
 },
 {
 ...
 label: `Badge ${idx + 1}`,
 content: `✓ ${item}`,
 className: 'bg-indigo-100/20 backdrop-blur-sm text-gray-900 text-xs font-semibold px-3 py-1 rounded-full',
 editable: true
 }))
 }
 ]
 ...
 className: `relative ${plan.popular ? 'bg-white text-indigo-600 scale-105 shadow-2xl' : 'bg-white/10 text-gray-900 backdrop-blur-lg'} rounded-2xl p-5 border-2 ${plan.popular ? 'border-indigo-100' : 'border-gray-300/30'} transition-all hover:scale-105`,
 children: [
 ...(plan.popular ? [{
 ...
 className: `text-xs mb-3 ${plan.popular ? 'text-indigo-500' : 'text-gray-600'} line-clamp-2`,
 editable: true
 },
 {
 ...
 className: `${plan.buttonStyle === 'solid' ? (plan.popular ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600') : (plan.popular ? 'border-2 border-indigo-600 text-indigo-600' : 'border-2 border-gray-300 text-gray-900')} px-4 py-2 rounded-lg font-bold hover:opacity-90 transition-all w-full shadow-lg text-sm`,
 editable: true
 }
 ]
 }))

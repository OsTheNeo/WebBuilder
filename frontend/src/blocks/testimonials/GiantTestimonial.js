...
const GiantTestimonial = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-96 bg-gradient-to-br from-yellow-500 via-orange-500 to-red-600 flex items-center justify-center px-8 py-12">
...
GiantTestimonial.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    className: 'w-full h-96 bg-gradient-to-br from-yellow-500 via-orange-500 to-red-600 flex items-center justify-center px-8 py-12',
    children: [
      {
            ...
            children: [
              {
                ...
                className: 'text-6xl font-extrabold text-white mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-yellow-100',
                editable: true
              },
              {
            ...
            children: (data.testimonials || GiantTestimonial.blockMeta.defaultData.testimonials).map((testimonial, index) => ({
              ...
              children: [
                ...
                },
                {
                  ...
                  className: 'text-white text-sm font-medium mb-3 italic leading-relaxed line-clamp-4',
                  editable: true
                },
                {

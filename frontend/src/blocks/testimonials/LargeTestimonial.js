...
const LargeTestimonial = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-64 bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center px-8 py-8">
...
LargeTestimonial.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    className: 'w-full h-64 bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center px-8 py-8',
    children: [
      {

...
const CompactTestimonial = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-32 bg-gradient-to-r from-yellow-400 to-yellow-600 flex items-center justify-center px-8">
...
CompactTestimonial.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    className: 'w-full h-32 bg-gradient-to-r from-yellow-400 to-yellow-600 flex items-center justify-center px-8',
    children: [
      {

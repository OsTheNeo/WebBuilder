...
const StandardTestimonial = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-48 bg-gradient-to-r from-yellow-400 to-yellow-600 flex items-center justify-center px-8 py-6">
...
StandardTestimonial.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    className: 'w-full h-48 bg-gradient-to-r from-yellow-400 to-yellow-600 flex items-center justify-center px-8 py-6',
    children: [
      {

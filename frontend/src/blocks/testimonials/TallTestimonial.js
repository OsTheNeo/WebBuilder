...
const TallTestimonial = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-80 bg-gradient-to-br from-yellow-500 via-yellow-600 to-orange-600 flex items-center justify-center px-8 py-10">
...
TallTestimonial.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    className: 'w-full h-80 bg-gradient-to-br from-yellow-500 via-yellow-600 to-orange-600 flex items-center justify-center px-8 py-10',
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: (data.testimonials || TallTestimonial.blockMeta.defaultData.testimonials).map((testimonial, index) => ({
              ...
              className: 'bg-white/15 backdrop-blur-lg rounded-2xl p-6 border border-white/25 hover:bg-white/25 transition-all transform hover:scale-105',
              children: [
                {
                ...
                },
                {
                  ...
                  className: 'text-white font-medium mb-3 italic leading-relaxed',
                  editable: true
                },
                {

...
const MediumCTA = ({ data = {} }) => {
 ...
 <button className="bg-red-600 text-gray-900 border-2 border-gray-300 px-8 py-3 rounded-lg font-bold hover:bg-red-800 transition-all transform hover:scale-105 text-lg">
 {secondaryCtaText}
 </button>
 </div>
 </div>
...
MediumCTA.blockMeta = {
 ...
 className: 'bg-red-600 text-gray-900 border-2 border-gray-300 px-8 py-3 rounded-lg font-bold hover:bg-red-800 transition-all transform hover:scale-105 text-lg',
 editable: true
 }
 ]
 }

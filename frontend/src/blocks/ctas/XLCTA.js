...
const XLCTA = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-80 bg-gradient-to-br from-red-600 via-red-700 to-pink-700 flex items-center justify-center px-8 py-10">
...
XLCTA.blockMeta = {
  ...
  getTree: (data = {}) => {
    ...
    return {
      ...
      tag: 'section',
      label: 'CTA Container',
      className: 'w-full h-80 bg-gradient-to-br from-red-600 via-red-700 to-pink-700 flex items-center justify-center px-8 py-10',
      children: [
        {
          id: 'xl-cta-wrapper',
          tag: 'div',
          ...
          children: [
            ...
            },
            {
              ...
              children: stats.map((stat, index) => ({
                ...
                tag: 'div',
                label: `Stat ${index + 1}`,
                className: 'bg-white/15 backdrop-blur-sm rounded-xl p-4 text-center border border-white/25',
                children: [
                  {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  className: 'bg-red-700 text-white border-3 border-white px-12 py-4 rounded-xl font-bold text-xl hover:bg-red-800 transition-all transform hover:scale-105 shadow-2xl',
                  editable: true
                }
              ]
            },

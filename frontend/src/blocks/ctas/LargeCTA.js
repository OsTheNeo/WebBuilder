...
const LargeCTA = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-64 bg-gradient-to-br from-red-500 to-red-700 flex items-center justify-center px-8 py-8">
...
LargeCTA.blockMeta = {
  ...
  getTree: (data = {}) => {
    ...
    return {
      ...
      tag: 'section',
      label: 'CTA Container',
      className: 'w-full h-64 bg-gradient-to-br from-red-500 to-red-700 flex items-center justify-center px-8 py-8',
      children: [
        {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  className: 'bg-red-700 text-white border-2 border-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-red-800 transition-all transform hover:scale-105 shadow-xl',
                  editable: true
                }
              ]
            },

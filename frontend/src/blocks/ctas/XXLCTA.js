...
const XXLCTA = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-96 bg-gradient-to-br from-red-600 via-pink-600 to-purple-700 flex items-center justify-center px-8 py-12">
...
XXLCTA.blockMeta = {
  ...
  getTree: (data = {}) => {
    ...
    return {
      ...
      tag: 'section',
      label: 'CTA Container',
      className: 'w-full h-96 bg-gradient-to-br from-red-600 via-pink-600 to-purple-700 flex items-center justify-center px-8 py-12',
      children: [
        {
          id: 'xxl-cta-wrapper',
          tag: 'div',
          ...
          children: [
              ...
              children: [
                {
                  ...
                  className: 'text-7xl font-extrabold text-white mb-5 bg-clip-text text-transparent bg-gradient-to-r from-white to-red-100 leading-tight',
                  editable: true
                },
                {
                  id: 'xxl-cta-subtitle',
            ...
            },
            {
              ...
              children: stats.map((stat, index) => ({
                ...
                tag: 'div',
                label: `Stat ${index + 1}`,
                className: 'bg-white/15 backdrop-blur-lg rounded-2xl p-5 text-center border-2 border-white/30 hover:bg-white/25 transition-all transform hover:scale-105',
                children: [
                  {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  className: 'bg-gradient-to-r from-red-700 to-pink-700 text-white border-3 border-white px-14 py-5 rounded-2xl font-bold text-xl hover:from-red-800 hover:to-pink-800 transition-all transform hover:scale-110 shadow-2xl',
                  editable: true
                },
                {
                  ...
                  className: 'bg-transparent text-white border-3 border-white px-14 py-5 rounded-2xl font-bold text-xl hover:bg-white/10 transition-all transform hover:scale-110',
                  editable: true
                }
              ]
            },
            {
              ...
              children: features.map((feature, index) => ({
                ...
                className: 'flex items-center gap-2 text-white justify-center bg-white/10 rounded-lg px-3 py-2',
                children: [
                  {
            ...
            },
            {
              ...
              children: badges.map((badge, index) => ({
                ...
                label: `Badge ${index + 1}`,
                content: badge,
                className: 'bg-white/20 backdrop-blur-sm text-white text-sm font-bold px-4 py-2 rounded-full border border-white/30',
                editable: true
              }))
            }
          ]

...
const XLTeam = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-80 bg-gradient-to-br from-teal-600 via-teal-700 to-cyan-800 flex items-center justify-center px-8 py-10">
          ...
          {members.map((member, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border-2 border-white/25 hover:bg-white/20 transition-all hover:scale-105">
              <div className="flex items-start gap-4 mb-4">
                <div className={`w-20 h-20 ${member.color} rounded-full flex items-center justify-center text-white font-bold text-2xl flex-shrink-0`}>
                  {member.initials}
                </div>
...
XLTeam.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    tag: 'section',
    label: 'Team Section',
    className: 'w-full h-80 bg-gradient-to-br from-teal-600 via-teal-700 to-cyan-800 flex items-center justify-center px-8 py-10',
    children: [
      {
        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                className: 'text-2xl text-teal-100 mb-2',
                editable: true
              },
              {
          ...
          },
          {
            ...
            children: (data.members || XLTeam.blockMeta.defaultData.members).map((member, index) => ({
              ...
              className: 'bg-white/10 backdrop-blur-lg rounded-2xl p-6 border-2 border-white/25 hover:bg-white/20 transition-all hover:scale-105',
              children: [
                {
                  ...
                  children: [
                    {
                      ...
                      className: `w-20 h-20 ${member.color} rounded-full flex items-center justify-center text-white font-bold text-2xl flex-shrink-0`,
                      editable: true
                    },
                    {
                      ...
                      children: [
                        ...
                        },
                        {
                          ...
                          children: member.expertise.map((skill, skillIdx) => ({
                            ...
                            content: skill,
                            className: 'bg-teal-900/40 text-teal-100 text-xs px-2 py-1 rounded-full',
                            editable: true
                          }))
                        }
                      ]

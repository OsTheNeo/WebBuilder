...
const LargeTeam = ({ data = {} }) => {
 ...
 <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-5 border border-gray-300/20 hover:bg-white/20 transition-all hover:scale-105">
 <div className="flex items-start gap-4 mb-3">
 <div className={`w-16 ${member.color} rounded-full flex items-center justify-center text-gray-900 font-bold text-xl flex-shrink-0`}>
 {member.initials}
 </div>
...
LargeTeam.blockMeta = {
 ...
 className: 'bg-white/10 backdrop-blur-lg rounded-2xl p-5 border border-gray-300/20 hover:bg-white/20 transition-all hover:scale-105',
 children: [
 {
 ...
 className: `w-16 ${member.color} rounded-full flex items-center justify-center text-gray-900 font-bold text-xl flex-shrink-0`,
 editable: true
 },
 {

...
const SmallGallery = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-32 bg-gradient-to-r from-pink-500 to-pink-600 flex items-center justify-center px-8">
        ...
        <div className="grid grid-cols-3 gap-3">
          {images.map((image, index) => (
            <div key={index} className="relative group overflow-hidden rounded-lg shadow-lg hover:scale-105 transition-transform cursor-pointer bg-pink-100">
              <div className="h-16 bg-gradient-to-br from-pink-300 to-pink-400 flex items-center justify-center text-white font-semibold text-sm">
...
SmallGallery.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    className: 'w-full h-32 bg-gradient-to-r from-pink-500 to-pink-600 flex items-center justify-center px-8',
    children: [
      {
              ...
              children: [
                {
                  ...
                  className: 'h-16 bg-gradient-to-br from-pink-300 to-pink-400 flex items-center justify-center text-white font-semibold text-sm',
                  children: [
                    {

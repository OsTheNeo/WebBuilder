...
const MediumGallery = ({ data = {} }) => {
 ...
 <div key={index} className="bg-pink-100 rounded-xl overflow-hidden shadow-xl hover:scale-105 transition-all cursor-pointer">
 <div className="h-16 flex items-center justify-center">
 <span className="text-gray-900 text-sm font-semibold">{image.title}</span>
 </div>
...
MediumGallery.blockMeta = {
 ...
 className: 'bg-pink-100 rounded-xl overflow-hidden shadow-xl hover:scale-105 transition-all cursor-pointer',
 children: [
 {

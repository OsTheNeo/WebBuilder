...
const LargeFooter = ({ data = {} }) => {
  ...
  return (
    <footer className="w-full h-64 bg-gray-800 flex items-center justify-center px-8 py-8">
        ...
        <div className="border-t border-gray-700 pt-6 flex justify-between items-center">
          ...
          <div className="flex gap-6">
            {socialLinks.map((social, index) => (
              <a key={index} href="#" className="text-gray-300 hover:text-white transition-all transform hover:scale-110 flex items-center gap-2">
...
LargeFooter.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    className: 'w-full h-64 bg-gray-800 flex items-center justify-center px-8 py-8',
    children: [
      {
            ...
            children: [
              ...
              },
              {
                ...
                children: (data.socialLinks || LargeFooter.blockMeta.defaultData.socialLinks).map((social, index) => ({
                  ...
                  className: 'text-gray-300 hover:text-white transition-all transform hover:scale-110 flex items-center gap-2',
                  children: [
                    {

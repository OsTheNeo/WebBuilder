...
const DetailedFooter = ({ data = {} }) => {
  ...
  return (
    <footer className="w-full h-80 bg-gray-900 flex items-center justify-center px-8 py-10">
      <div className="max-w-7xl w-full">
        <div className="grid grid-cols-6 gap-6 mb-8">
          <div className="col-span-2">
            ...
            <div>
              <h4 className="text-white font-bold mb-2 text-sm">{newsletterTitle}</h4>
              <div className="flex gap-2">
                <input
                  type="email"
                  placeholder={newsletterPlaceholder}
                  className="flex-1 px-3 py-2 bg-gray-800 text-white rounded border border-gray-700 focus:outline-none focus:border-gray-600 text-sm"
                />
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-6">
              {socialLinks.map((social, index) => (
                <a key={index} href="#" className="group text-gray-300 hover:text-white transition-all flex flex-col items-center">
...
DetailedFooter.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    className: 'w-full h-80 bg-gray-900 flex items-center justify-center px-8 py-10',
    children: [
      {
                ...
                children: [
                  {
                    ...
                    className: 'font-bold text-white text-4xl mb-3',
                    editable: true
                  },
                  {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    children: (data.socialLinks || DetailedFooter.blockMeta.defaultData.socialLinks).map((social, index) => ({
                      ...
                      className: 'group text-gray-300 hover:text-white transition-all flex flex-col items-center',
                      children: [
                        {

...
const MegaFooter = ({ data = {} }) => {
  ...
  return (
    <footer className="w-full h-96 bg-gray-900 flex items-center justify-center px-8 py-12">
      <div className="max-w-7xl w-full">
        {/* Top Section */}
        <div className="grid grid-cols-7 gap-6 mb-8">
          {/* Company Info */}
          <div className="col-span-2">
            <div className="font-extrabold text-white text-4xl mb-3">{companyName}</div>
            ...
            {/* Newsletter */}
            <div className="mb-6">
              <h4 className="text-white font-bold mb-3 text-sm">{newsletterTitle}</h4>
              <div className="flex gap-2 mb-2">
                <input
                  type="email"
                  placeholder={newsletterPlaceholder}
                  className="flex-1 px-3 py-2 bg-gray-800 text-white rounded-lg border border-gray-700 focus:outline-none focus:border-gray-600 text-sm"
                />
            ...
            <div key={index}>
              ...
              <div className="space-y-2">
                {section.links.map((link, idx) => (
                  <a key={idx} href="#" className="block text-gray-300 hover:text-white transition-colors text-xs">
                    {link}
                  </a>
                ))}
              </div>
...
MegaFooter.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    className: 'w-full h-96 bg-gray-900 flex items-center justify-center px-8 py-12',
    children: [
      {
                ...
                children: [
                  {
                    ...
                    className: 'font-extrabold text-white text-4xl mb-3',
                    editable: true
                  },
                  {
                ...
                children: [
                  {
                    ...
                    className: 'font-bold text-white mb-4 text-xs uppercase tracking-wider',
                    editable: true
                  },
                  {
                    ...
                    children: section.links.map((link, idx) => ({
                      ...
                      label: `Link: ${link}`,
                      content: link,
                      className: 'block text-gray-300 hover:text-white transition-colors text-xs',
                      editable: true
                    }))
                  }
                ]

...
const LargeFeatures = ({ data = {} }) => {
  ...
  return (
    <section className="w-full h-64 bg-gradient-to-br from-green-500 to-green-700 flex items-center justify-center px-8 py-8">
...
LargeFeatures.blockMeta = {
  ...
  getTree: (data = {}) => ({
    ...
    className: 'w-full h-64 bg-gradient-to-br from-green-500 to-green-700 flex items-center justify-center px-8 py-8',
    children: [
      {
